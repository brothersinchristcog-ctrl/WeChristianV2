...
async function run() {
  try {
    ...
    const options = {
      ...
      path: '/services/data/v60.0/sobjects/Schedule_Event__c/describe',
    ...
    https.get(options, (res) => {
      ...
      res.on('end', () => {
        ...
        fs.writeFileSync('event_fields.json', JSON.stringify(fields, null, 2));
        console.log('SUCCESS: Saved to event_fields.json');
      });
    });
  } catch (e) {
    console.error(e);
