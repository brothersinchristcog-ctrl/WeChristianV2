...
function TabNavigator() {
  ...
  const isActualAdmin = member?.userType?.toLowerCase() === 'admin' || member?.userType?.toLowerCase() === 'super_admin' || member?.role?.toLowerCase() === 'admin';
...
function Navigation() {
  ...
  const isAdmin = member?.userType?.toLowerCase() === 'admin' || member?.userType?.toLowerCase() === 'super_admin' || member?.role?.toLowerCase() === 'admin';
